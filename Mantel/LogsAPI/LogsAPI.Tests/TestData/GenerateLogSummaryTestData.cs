    ...
    internal class GenerateLogSummaryTestData : IEnumerable<object[]>
    {
        ...
        private IEnumerable<object[]> _data = new List<object[]>()
        {
            new object[]
            {
                ...
                new List<RankedItem>() 
                { 
                    new RankedItem(rank: 1, value: "/intranet-analytics/"),
                    new RankedItem(rank: 2, value: "/external-analytics/"),
                    new RankedItem(rank: 3, value: "/asset.css")
                },
                new List<RankedItem>()
                {
                    new RankedItem(rank: 1, value: "177.71.128.21"),
                    new RankedItem(rank: 2, value: "50.112.00.11"),
                    new RankedItem(rank: 3, value: "72.44.32.10")
                }
